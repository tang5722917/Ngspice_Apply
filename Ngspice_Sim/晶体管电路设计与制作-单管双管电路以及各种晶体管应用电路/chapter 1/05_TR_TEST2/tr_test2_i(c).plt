...
set title "TR_TEST2_I(C) Temperature:0,25,50,75,100"
set xlabel "V(bias) Voltage/V"
...
plot 'tr_test2_i(c).data' using 1:2 with lines lw 3 title "out2"
set terminal push
set terminal png noenhanced
set out 'tr_test2_i(c).png'
replot
set term pop
replot
